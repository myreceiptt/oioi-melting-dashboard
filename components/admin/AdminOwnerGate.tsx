  ...
  if (!isConnected) {
    return (
      <div className="rounded-3xl border border-yellow-500/30 bg-yellow-500/10 p-5">
        <h2 className="font-semibold text-yellow-100">Admin wallet required</h2>
        <p className="mt-2 text-sm text-yellow-100/80">
          Connect the owner/deployer wallet before using admin controls.
        </p>
    ...
    return (
      <div className="rounded-3xl border border-red-500/30 bg-red-500/10 p-5">
        ...
        <p className="mt-2 text-sm text-red-100/80">
          The connected wallet is not the expected owner. Admin write actions
          must stay disabled for this wallet.
        </p>
  ...
  return (
    <div className="rounded-3xl border border-green-500/30 bg-green-500/10 p-5">
      ...
      <p className="mt-2 text-sm text-green-100/80">
        Admin write actions may be enabled in later stages. Review every action
