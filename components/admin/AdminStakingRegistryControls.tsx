...
export function AdminStakingRegistryControls({
  ...
  const collections: StakingCollectionConfig[] = [
    {
      ...
      warning:
        "ROTY staking is the root eligibility signal for Melting and Amanda gated mint and downstream reward participation.",
    },
    {
      key: "melting",
  ...
  return (
    <section className="grid gap-5 scroll-mt-30" id="registry-controls">
