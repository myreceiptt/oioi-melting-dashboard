    ...
    <section className="rounded-3xl border border-white/10 bg-white/5 p-6">
      <div>
        ...
        <p className="mt-2 text-sm text-white/60">
          Public mint uses the connected wallet directly. The same wallet should
          be used later for staking and claiming.
        </p>
      </div>
      ...
      <div className="mt-6 rounded-2xl border border-white/10 bg-black/20 p-4">
        ...
        <p className="mt-2 text-sm text-white/60">
          Whitelist mint will be added after the Merkle proof delivery strategy
          is connected to the frontend.
        </p>
        <div className="mt-3 text-sm text-white/60">
          This wallet whitelist claimed:{" "}
