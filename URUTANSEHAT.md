...
2. Complete Testnet Frontend Application — DONE
   ...
   - ✅ Admin Reward Round Controls v2 done.
   ...
   - ✅ Test/preview route domain mapping done.
   - ✅ Sepolia env wiring on Vercel verified.
   - ✅ Testnet Public Surface QA done.

3. Complete Database Indexer + Reward Pipeline on Testnet — IN PROGRESS
...
4. Stage-by-Stage Browser Testing — IN PROGRESS / CONTINUOUS
   ...
   - ✅ Admin dashboard browser QA done.
   - ✅ Admin controlled operations QA done.
   - 🔜 Reward claim browser testing.

5. Full Testnet Browser E2E — NOT STARTED
   - 🔜 User mint ROTY.
   - 🔜 User stake ROTY.
...
6. Final UI/UX Polish — NOT STARTED
   - 🔜 Homepage.
   - 🔜 Mint pages.
   - 🔜 User dashboard.
   - 🔜 Admin dashboard.
...
7. Testnet Release Candidate — NOT STARTED
...
8. Mainnet Deployment — READY BUT DEFERRED
...
11. Controlled Mainnet Opening — NOT STARTED
