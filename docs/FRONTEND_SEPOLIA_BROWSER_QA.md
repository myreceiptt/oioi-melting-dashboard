...
> Current status note (2026-06-29): this is a historical Sepolia browser QA
> record. The current canonical project status is
> `docs/PROJECT_FINAL_STATUS_AND_MAINTENANCE_V1.md`: complete, public,
> operational, and in evergreen maintenance mode. Any older pending items below
> describe the state at the time this document was written.
